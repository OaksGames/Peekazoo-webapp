...
function Contact() {
  const audiences = [
    { tag: 'Governments', cta: 'Request consultation', href: '/#join',    color: PZ.blue,  char: '../assets/nimu.webp', body: 'Bring foundational learning to your districts and communities.' },
    { tag: 'Schools',     cta: 'Book a demo',           href: '/#join',    color: PZ.green, char: '../assets/mimi.webp', body: 'Boost classroom engagement and extend learning beyond the bell.' },
    { tag: 'Parents',     cta: 'Get access',            href: '#get-access', color: PZ.coral, char: '../assets/pebi.webp', body: 'Turn screen time into guided learning your child will love.' },
    { tag: 'Partners',    cta: 'Partner with us',       href: '#partner', color: PZ.lilac, char: '../assets/jiku.webp', body: 'Scale early learning across communities, together.' },
  ];
        ...
        <Reveal from="scale">
          <div style={{
            ...
            <div style={{
              ...
              {[
                { src: '../assets/pebi.webp', size: 200, c: PZ.coral,  delay: 0    },
                { src: '../assets/mimi.webp', size: 180, c: PZ.gold,   delay: 0.4  },
                { src: '../assets/nimu.webp', size: 200, c: PZ.blue,   delay: 0.8  },
                { src: '../assets/jiku.webp', size: 180, c: PZ.lilac,  delay: 1.2  },
              ].map((p, i) => (
                <div key={i} style={{
        ...
        <div style={{
          ...
          <div>
            <a href="/" style={{ display: 'inline-block', lineHeight: 0 }}>
              <img src="../assets/logo.webp" alt="Peek-A-Zoo" style={{ height: 42, filter: 'brightness(1.05)' }} />
            </a>
            ...
            <div style={{ marginTop: 26 }}>
              <FeltButton variant="gold" size="md" href="/#join" icon={<ArrowIcon/>}>Join the early list</FeltButton>
            </div>
          </div>
          ...
          <div>
            <h4>Audiences</h4>
            <a href="/#join">Governments</a>
            <a href="/#join">Schools</a>
