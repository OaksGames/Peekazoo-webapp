            ...
            <Reveal from="left" delay={1}>
              <div className="pz-solutions-logo" style={{ marginTop: 20 }}>
                <a href="/" style={{ display: 'inline-block', lineHeight: 0 }}>
                  <img src="../assets/logo.webp" alt="Peek-A-Zoo" />
                </a>
              </div>
            </Reveal>
        ...
        <Reveal from="scale">
          <div style={{ marginTop: 64 }}>
            <SolutionCard
              ...
              body="Enable early learning across community learning centers, districts, and public programs — with deployment models built for scale, offline access, and cohort-level visibility."
              highlights={[
              'NEP 2020 / ECCE / FLN aligned',
              'Community-ready deployment',
              ...
              ctaVariant="gold"
              color={PZ.blue}
              character="../assets/nimu.webp"
              characterName="Nimu · The dreamy wonderer" />
        ...
        <div className="pz-stagger pz-solutions-grid" style={{
          ...
          <Reveal from="up">
            <SolutionCard
              ...
              ctaVariant="green"
              color={PZ.green}
              character="../assets/mimi.webp"
              characterName="Nimu + Mimi" />
          ...
          <Reveal from="up">
            <SolutionCard
              ...
              ctaVariant="coral"
              color={PZ.coral}
              character="../assets/pebi.webp"
              characterName="Pebi + Jiku" />
...
function SolutionCard({ featured, eyebrow, title, body, highlights, cta, ctaVariant, color, character, characterName, ctaHref = '/#join' }) {
  if (featured) {
    return (
      <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <img
          ...
          alt="The Peek-A-Zoo ecosystem: Pebi, Nimu, Mimi and Jiku surrounded by parents, teachers and classroom UI hovering in their world — games, storybooks, AI tutoring, AR learning, multilingual learning."
          style={{
