...
function Impact() {
  ...
  const outcomes = [
    ...
    { icon: '⚙️', title: 'Scalable implementation', body: 'Community-ready models that work across districts.' },
          ...
          <div className="pz-impact-copy">
            ...
            <Reveal from="left" delay={2}>
              <p className="pz-body-lg" style={{ marginTop: 22, fontSize: 17, maxWidth: 'none' }}>
                Peek-A-Zoo has supported foundational learning through community learning centers in Jharkhand,
          ...
          <div style={{
            ...
            <div>
              ...
              <h3 style={{
                ...
                Foundational learning, delivered through the community ecosystem.
              </h3>
...
function FeltPhoto({ src, tint = PZ.gold, size = 160, rotate = 0, aspectRatio = '1' }) {
  return (
    <div style={{
      ...
      <img src={src} alt="Peek-A-Zoo in the community learning ecosystem, Jharkhand"
        style={{
