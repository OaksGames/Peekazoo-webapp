  ...
  const characters = [
    {
      id: 'pebi',
      name: 'Pebi',
      tagline: 'The joyful bloomer',
      species: 'Petal sprite · she/her',
      img: '../assets/pebi.webp',
      bg: PZ.coral, tintBg: PZ.pinkTint,
      traits: ['Joyful', 'Curious', 'Brave', 'Warm', 'Energetic'],
      power: 'Heart & friendship',
      role: 'Main protagonist',
      quote: 'Let\u2019s see what\u2019s over there!',
    },
    {
      id: 'nimu',
      name: 'Nimu',
      tagline: 'The dreamy wonderer',
      species: 'Wonder sprite · she/her',
      img: '../assets/nimu.webp',
      bg: PZ.lilac, tintBg: PZ.lilacTint,
      traits: ['Imaginative', 'Calm', 'Gentle', 'Wise', 'Thoughtful'],
      power: 'Calm thinking',
      role: 'Guide & co-lead',
      quote: 'Let’s think about it first.',
    },
    {
      id: 'mimi',
      name: 'Mimi',
      tagline: 'The clever nut',
      species: 'Acorn sprite · she/her',
      img: '../assets/mimi.webp',
      bg: PZ.gold, tintBg: PZ.goldTint,
      traits: ['Clever', 'Witty', 'Playful', 'Quick-thinking', 'Curious'],
      power: 'Imagination & empathy',
    ...
    },
    {
      id: 'jiku',
      name: 'Jiku',
      tagline: 'The bouncy spark',
      species: 'Spark sprite · he/him',
      img: '../assets/jiku.webp',
      bg: PZ.blue, tintBg: PZ.blueTint,
      traits: ['Energetic', 'Kind-hearted', 'Supportive', 'Playful', 'Warm'],
      power: 'Energy & courage',
      role: 'Emotional support',
      quote: 'Come on! Let’s try!',
    },
  ];
      ...
      <div className="pz-container">
        <div className="pz-section-intro--center">
          ...
          <Reveal from="up" delay={2}>
            <p className="pz-body-lg" style={{ marginTop: 24, fontSize: 19 }}>
              ...
              Children join Pebi and Nimu as they explore, solve, ask, and grow with confidence.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal from="up">
          <div className="pz-char-strip pz-stagger" style={{
            marginTop: 28, display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14,
          }}>
            {characters.map((c, i) => (
