        ...
        <div style={{ minWidth: 0 }}>
          ...
          <Reveal from="up" delay={4}>
            <div style={{ display: 'flex', gap: 16, marginTop: 36, flexWrap: 'wrap' }}>
              <FeltButton variant="gold" size="lg" href="/#join" icon={<ArrowIcon />}>Join the early list</FeltButton>
...
function HeroScene() {
  // Group portrait of the four Peek-A-Zoo heroes.
  // Back row (smaller, higher up): Nimu, Jiku.
  // Front row (larger, on the ground): Mimi.
  // Pebi — the lead — sits dead center, largest of all.
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src="../assets/nimu.webp" alt="Nimu" style={{ width: '100%', filter: 'drop-shadow(0 12px 18px rgba(61,44,30,0.18))' }} />
      </div>
      ...
      <div style={{
        ...
        <img src="../assets/jiku.webp" alt="Jiku" style={{ width: '100%', filter: 'drop-shadow(0 12px 18px rgba(61,44,30,0.18))' }} />
      </div>
      ...
      <div style={{
        ...
        <img src="../assets/mimi.webp" alt="Mimi" style={{ width: '100%', filter: 'drop-shadow(0 14px 20px rgba(61,44,30,0.20))' }} />
      </div>

      {/* ───── PEBI — DEAD CENTER OF THE SUN DISK, LARGER ───── */}
      {/* Outer div handles centering; inner div handles the float animation.
                                             ...
                                             transform overwrites the translate(-50%, -50%) and Pebi drifts.) */}
      <div style={{
        position: 'absolute', left: '50%', top: '46%', transform: 'translate(-50%, -50%)',
        width: '42%', zIndex: 7
      }}>
        <div style={{ animation: 'pz-float-a 5.8s ease-in-out infinite' }}>
          <img src="../assets/pebi.webp" alt="Pebi" style={{ width: '100%', display: 'block', filter: 'drop-shadow(0 22px 30px rgba(61,44,30,0.30))' }} />
        </div>
      </div>
