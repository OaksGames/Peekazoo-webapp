...
function Challenge() {
  ...
  const problems = [
    ...
    { tag: '04', title: 'Teacher constraints', body: 'Early-childhood workers and educators are stretched thin, lacking modern tools to extend their reach.' },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <img
          ...
          alt="A curious child looks toward Pebi, Nimu, Mimi and Jiku emerging from a glowing portal — the threshold between an under-supported childhood and rich foundational learning."
          style={{
