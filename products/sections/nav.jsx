    ...
    <React.Fragment>
      <nav className={`pz-nav ${scrolled ? 'is-scrolled' : ''}`}>
        <div className="pz-nav-shell">
          <a href="/" className="pz-nav-logo" aria-label="Peek-A-Zoo home">
          ...
          <div className="pz-nav-cta">
            <FeltButton variant="gold" size="sm" href="/#join" icon={<ArrowIcon/>}>
              Join the early list
            </FeltButton>
          </div>
          <button
      ...
      <div className={`pz-mobile-sheet ${open ? 'is-open' : ''}`} role="dialog" aria-hidden={!open}>
        ...
        <div style={{ padding: '14px 4px 6px' }}>
          <FeltButton variant="gold" size="sm" href="/#join" icon={<ArrowIcon/>} style={{ width: '100%', justifyContent: 'center' }}>
            Join the early list
          </FeltButton>
        </div>
      </div>
