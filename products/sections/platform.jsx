...
function Platform() {
  const modules = [
    { name: 'Interactive Games',     icon: 'assets/icon-number-one.webp',  color: PZ.green,  char: 'Mimi' },
    { name: 'Videos, Rhymes & Stories', icon: 'assets/icon-story.webp',    color: PZ.coral,  char: 'Pebi' },
    { name: 'Adaptive Worksheets',   icon: 'assets/icon-tracing-two.webp', color: PZ.gold,   char: 'Pebi' },
    { name: 'AI Learning Intelligence', icon: 'assets/icon-rhyme.webp',    color: PZ.lilac,  char: 'Nimu' },
    { name: 'Immersive AR Learning', icon: 'assets/icon-number-three.webp', color: PZ.blue,  char: 'Pebi' },
    { name: 'Multilingual Learning', icon: 'assets/icon-tracing-one.webp', color: PZ.pink,   char: 'Nimu' },
    { name: 'Dashboards & Analytics', icon: 'assets/icon-tracing-three.webp', color: PZ.green, char: 'Nimu' },
  ...
  return (
    <div className="pz-platform-orbit" style={{
      ...
      <div style={{
        ...
        <img src="../assets/pebi.webp" alt="" style={{ width: '78%', height: '78%', objectFit: 'contain', position: 'relative', zIndex: 1, filter: 'drop-shadow(0 8px 12px rgba(0,0,0,0.18))' }} />
      </div>
