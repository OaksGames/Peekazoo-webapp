        ...
        <Reveal from="scale">
          <div style={{
            ...
            <div style={{ display: 'flex', gap: -8 }}>
              <CharacterPortrait src="../assets/nimu.webp" color={PZ.blueTint} size={96} style={{ boxShadow: '0 6px 14px rgba(46,144,200,0.20)' }} />
              <CharacterPortrait src="../assets/jiku.webp" color={PZ.lilacTint} size={96} style={{ marginLeft: -28, boxShadow: '0 6px 14px rgba(138,92,200,0.20)' }} />
            </div>
            <div>
            ...
            <FeltButton variant="blue" size="sm" href="/#join" icon={<ArrowIcon/>}>Talk to security team</FeltButton>
          </div>
        </Reveal>
      </div>
