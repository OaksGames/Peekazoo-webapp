...
function PartnerForm() {
  ...
  const BENEFICIARY_OPTIONS = [
    'Community-center learners', 'Pre-primary learners', 'Schools',
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 2, display: 'flex', alignItems: 'center', gap: 14 }}>
            <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(255,255,255,0.20)', overflow: 'hidden', flexShrink: 0, position: 'relative' }}>
              <img src="../assets/nimu.webp" alt="" style={{ position: 'absolute', left: '-12%', top: '-12%', width: '124%', height: '124%', objectFit: 'contain' }}/>
